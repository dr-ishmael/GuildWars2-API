...
This method constructs a new C<GuildWars2::API> object and returns it. Key/value pairs of
...
Returns a C<GuildWars2::API::Guild> object containing detailed information for
the given guild ID or guild name. If the argument doesn't match the pattern of a
guild ID, it is assumed to be a guild name. The object contains the following
attributes:
 ...
 (
   ...
   emblem     =>              # GuildWars2::API::Guild::Emblem object
     {
