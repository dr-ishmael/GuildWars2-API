...
--
-- Table structure for table `map_sector_tb`
--

DROP TABLE IF EXISTS `map_sector_tb`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `map_sector_tb` (
  `map_id` smallint(6) unsigned NOT NULL,
  `sector_id` smallint(5) unsigned NOT NULL,
  `sector_name` varchar(128) NOT NULL,
  `sector_level` smallint(5) unsigned NOT NULL,
  `sector_coord_x` decimal(6,1) unsigned NOT NULL,
  `sector_coord_y` decimal(6,1) unsigned NOT NULL,
