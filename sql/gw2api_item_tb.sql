...
CREATE TABLE `item_tb` (
  ...
  `item_rarity` varchar(32) NOT NULL,
  `item_description` varchar(1024) DEFAULT NULL,
  `vendor_value` mediumint(8) unsigned NOT NULL,
  `game_type_activity` tinyint(1) unsigned NOT NULL,
  `game_type_dungeon` tinyint(1) unsigned NOT NULL,
  `game_type_pve` tinyint(1) unsigned NOT NULL,
  `game_type_pvp` tinyint(1) unsigned NOT NULL,
  `game_type_pvplobby` tinyint(1) unsigned NOT NULL,
  `game_type_wvw` tinyint(1) unsigned NOT NULL,
  `flag_accountbound` tinyint(1) unsigned NOT NULL,
  `flag_hidesuffix` tinyint(1) unsigned NOT NULL,
  `flag_nomysticforge` tinyint(1) unsigned NOT NULL,
  `flag_nosalvage` tinyint(1) unsigned NOT NULL,
  `flag_nosell` tinyint(1) unsigned NOT NULL,
  `flag_notupgradeable` tinyint(1) unsigned NOT NULL,
  `flag_nounderwater` tinyint(1) unsigned NOT NULL,
  `flag_soulbindonacquire` tinyint(1) unsigned NOT NULL,
  `flag_soulbindonuse` tinyint(1) unsigned NOT NULL,
  `flag_unique` tinyint(1) unsigned NOT NULL,
  `item_file_id` mediumint(8) unsigned NOT NULL,
  `item_file_signature` char(40) NOT NULL,
  `equip_prefix` varchar(32) DEFAULT NULL,
  `equip_infusion_slot` varchar(32) DEFAULT NULL,
  ...
  `upgrade_applies_to` varchar(32) DEFAULT NULL,
