...
--
-- Table structure for table `map_floor_x_task_tb`
--

DROP TABLE IF EXISTS `map_floor_x_task_tb`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `map_floor_x_task_tb` (
  `task_id` smallint(6) NOT NULL,
  `map_id` smallint(6) NOT NULL,
  `floor_id` smallint(6) NOT NULL,
  PRIMARY KEY (`task_id`,`map_id`,`floor_id`)
