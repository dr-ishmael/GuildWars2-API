...
--
-- Table structure for table `map_floor_x_sector_tb`
--

DROP TABLE IF EXISTS `map_floor_x_sector_tb`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `map_floor_x_sector_tb` (
  `sector_id` smallint(6) NOT NULL,
  `map_id` smallint(6) NOT NULL,
  `floor_id` smallint(6) NOT NULL,
  PRIMARY KEY (`sector_id`,`map_id`,`floor_id`)
